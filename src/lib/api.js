...
export const API_ENDPOINTS = Object.freeze({
  ...
  editorProfileSetup: `${API_PREFIX}/editor/profile`,
  ...
  adminProjectCancellation: (id) => `${API_PREFIX}/admin/projects/${id}/cancel`,
  adminAnalytics: `${API_PREFIX}/admin/analytics/summary`,
  adminNotifications: `${API_PREFIX}/admin/notifications`,
  adminNotificationRetry: (id) => `${API_PREFIX}/admin/notifications/${id}/retry`,
...
export function getApiError(error, fallback = 'Something went wrong. Please try again.') {
  ...
  const friendlyMessages = {
    ...
    EDITOR_NOT_FOUND: 'That Nerd is unavailable.',
    ...
    EDITOR_PROFILE_INCOMPLETE: 'Complete your Nerd profile before opening the Nerd workspace.',
    ...
    SAME_EDITOR: 'This project is already assigned to that Nerd.',
...
export const editorApi = {
  ...
  profileSetup: () => api.get(API_ENDPOINTS.editorProfileSetup).then((r) => r.data),
  saveProfile: (data) => api.put(API_ENDPOINTS.editorProfileSetup, data).then((r) => r.data),
...
export const adminApi = {
  ...
  cancelProject: (id, data) => api.post(API_ENDPOINTS.adminProjectCancellation(id), data).then((r) => r.data),
  ...
  retryNotification: (id) => api.post(API_ENDPOINTS.adminNotificationRetry(id)).then((r) => r.data),
